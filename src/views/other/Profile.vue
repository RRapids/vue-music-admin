      ...
      <v-col cols="12" sm="8">
        <v-card max-width="375">
          <v-card-title class="cyan darken-1">
            <span class="headline white--text">About</span>
          ...
          <v-list>
            ...
            <v-list-item>
              ...
              <v-list-item-content>
                <v-list-item-title>18851856989</v-list-item-title>
              </v-list-item-content>
            ...
            <v-list-item>
              ...
              <v-list-item-content>
                <v-list-item-title>798763046@qq.com</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
            ...
            <v-list-item>
              ...
              <v-list-item-content>
                <v-list-item-title>FuYang,Anhui</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </v-list>
        </v-card>
